...
* proxy  将会我们下载从远程仓库download下来的jar，方便下次寻找不用再去远程仓库拉去，直接去这里拉取就可以。
...
<settings xmlns="http://maven.apache.org/SETTINGS/1.0.0"
  ...
  <mirrors>
	...
	<!--<mirror>
	  ...
	  <mirrorOf>*</mirrorOf>
	  <name>nexus</name>
	  <url>http://192.168.10.40:8099/repository/maven-public/</url>
	</mirror>-->
  </mirrors>
...
<repositories>
    ...
    <repository>
       ...
       <url>http://192.168.10.40:8099/repository/maven-central/</url>
       <releases>
         <enabled>true</enabled>
       </releases>
       <snapshots>
    ...
    <repository>
      ...
      <url>http://192.168.10.40:8099/repository/maven-releases/</url>
      <releases>
        <enabled>true</enabled>
      </releases>
      <snapshots>
    ...
    <repository>
      ...
      <url>http://192.168.10.40:8099/repository/maven-snapshots/</url>
      <releases>
        <enabled>false</enabled>
      </releases>
      <snapshots>
 ...
 <pluginRepositories>
    ...
    <pluginRepository>
      <id>central</id>
      <url>http://192.168.10.40:8099/repository/maven-central/
      </url>
      <releases>
        <enabled>true</enabled>
      </releases>
